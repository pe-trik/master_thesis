...
\begin{enumerate}
    ...
    \item \texttt{iwslt2020.pdf} --- our paper accepted to IWSLT2020 \citep{iwslt20-polak},
    \item \texttt{interspeech2020.pdf} -- our paper submitted to Interspeech 2020,
    \item \texttt{acoustic\_models/} --- scripts and outputs of the acoustic and ASR models as discussed in \cref{chapter:asr},
