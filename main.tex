...
\include{asr}
\include{enhanced_asr}
\include{slt}
\include{finetune_enhanced_asr}
\include{adaptation}
%\include{onlinezation}
\include{conclusion}
...
\begin{enumerate}
    ...
    \item \XXX{the submitted papers?}
    \item \texttt{accoustc\_models/} --- scripts and outputs of the acoustic and ASR models,
    \item \texttt{translation\_models/} --- the Transformer models, ASR transcripts and SLT translations,
    \item \texttt{online\_adaptation/} --- the online adaptation algorithms, test sets and outputs.
\end{enumerate}
